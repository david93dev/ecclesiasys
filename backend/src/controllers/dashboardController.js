...
exports.getDashboard = async (req, res) => {
    try {
        ...
        const offers = totalMonth.find(item => item._id === "offering")?.total || 0
        const missions = totalMonth.find(item => item._id === "missions")?.total || 0

        const totalAmount = tithes + offers + missions
